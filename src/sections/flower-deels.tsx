  ...
  return (
    <div className="flex flex-wrap gap-6 p-6 mt-[100px] container mx-auto justify-center">
      {deals.map((deal, index) => (
        <div
          key={index}
          className={`relative rounded-2xl shadow-lg overflow-hidden ${deal.bgColor} ${deal.textColor} w-full md:w-[48%] h-[390px] `}
        >
          <div className="p-8 w-1/2 h-full flex flex-col justify-center z-10 relative">
            ...
            <p className="text-base text-gray-500 dark:text-gray-300 mb-4">{deal.description}</p>
            <button
