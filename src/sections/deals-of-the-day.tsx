  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          <h2 className="text-sm font-semibold text-purple-600 uppercase tracking-wide mb-1">Best Seller</h2>
          <p className="text-2xl font-bold text-gray-800">Deals of the Day</p>
          <p className="text-gray-600 text-sm">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam.</p>
        </div>
        ...
        {/* Optional: Banner on the left */}
        <div className="relative rounded-lg overflow-hidden shadow-md mt-8">
          <div className="relative h-64 md:h-80">
            <Image src="/assets/top-seller-img.jpg" alt="Deals Banner" layout="fill" objectFit="cover" />
            <div className="absolute inset-0 bg-purple-600 bg-opacity-70 flex flex-col items-center justify-center text-white text-center p-6">
